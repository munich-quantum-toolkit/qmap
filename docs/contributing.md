...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/qmap/issues>.
...
which contains context and instructions to help the agent work on MQT QMAP.
...
MQT QMAP adheres to [Semantic Versioning],
...
Use it to explain how users may need to adapt their usage of MQT QMAP,
...
When it is time to release a new version of MQT QMAP,
