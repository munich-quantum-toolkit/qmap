...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-qmap`
...
- NEVER edit `.pyi` files in `python/mqt/qmap/` manually; they are auto-generated by nanobind stubgen.
