...
class RoutingAgnosticCompiler:
    ...
    def __init__(
        ...
        Args:
            ...
            max_filling_factor: is the maximum filling factor for the entanglement zone, i.e., it set the limit for the maximum number of entangling gates that are scheduled in parallel
...
class FastRoutingAwareCompiler:
    """MQT QMAP's fast, routing-aware Zoned Neutral Atom Compiler."""
    ...
    def __init__(
        ...
        """Create a fast routing-aware compiler for the given architecture and configurations.
        ...
        Args:
            ...
            reuse_level: is the reuse level that corresponds to the estimated extra
                ...
                reused and instead moved to the storage zone and back to the
                entanglement zone
            trials: is the number of trials to run the DFS within the placer
            queue_capacity: is the capacity of the priority queue used in the placer
            parking_offset: is the parking offset of the code generator
            warn_unsupported_gates: is a flag whether to warn about unsupported gates
                in the code generator
        """
    @classmethod
    def from_json_string(cls, arch: ZonedNeutralAtomArchitecture, json: str) -> FastRoutingAwareCompiler:
        """Create a compiler for the given architecture and configurations from a JSON string.
...
class RelaxedRoutingAwareCompiler:
    """MQT QMAP's relaxed, routing-aware Zoned Neutral Atom Compiler."""
    ...
    def __init__(
        ...
        Args:
            ...
            max_nodes: is the maximum number of nodes that are considered in the A*
                ...
                Byte. Hence, allowing 50,000,000 nodes results in memory consumption of
                about 6 GB plus the size of the rest of the data structures.
            prefer_split: is the preference for splitting the rearrangements into
                separate rearrangement steps
            parking_offset: is the parking offset of the code generator
            warn_unsupported_gates: is a flag whether to warn about unsupported gates
                in the code generator
        """
