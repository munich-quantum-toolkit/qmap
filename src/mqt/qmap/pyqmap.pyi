...
class HybridSynthesisMapper:
    def __init__(
        self, arch: NeutralAtomHybridArchitecture, params: HybridMapperParameters = ..., buffer_size: int = ...
    ) -> None: ...
    ...
    @overload
    def evaluate_synthesis_steps(
        self, synthesis_steps: list[object], complete_remap: bool = ..., also_map: bool = ...
    ) -> list[float]: ...
    def get_animation_csv(self) -> str: ...
