...
class HybridSynthesisMapper:
    def __init__(self, arch: NeutralAtomHybridArchitecture, params: HybridMapperParameters = ...) -> None: ...
    def append_with_mapping(self, qc: object, complete_remap: bool = ...) -> None: ...
    def append_without_mapping(self, qc: object) -> None: ...
    def complete_remap(self) -> None: ...
    def convert_to_aod(self) -> QuantumComputation: ...
    @overload
    def evaluate_synthesis_steps(self, synthesis_steps: list[QuantumComputation], complete_remap: bool = ..., also_map: bool = ...) -> list[float]: ...
    @overload
    def evaluate_synthesis_steps(self, synthesis_steps: list[object], complete_remap: bool = ..., also_map: bool = ...) -> list[float]: ...
    def get_animation_csv(self) -> str: ...
    def get_circuit_adjacency_matrix(self) -> list[list[int]]: ...
    def get_init_hw_pos(self) -> dict[int, int]: ...
    def get_mapped_qc(self) -> str: ...
    def get_mapped_qc_aod(self) -> str: ...
    def get_max_gate_size(self) -> int: ...
    def get_synthesized_qc(self) -> str: ...
    def init_mapping(self, n_qubits: int, initial_mapping: InitialCircuitMapping = ...) -> None: ...
    def save_animation_csv(self, filename: str) -> None: ...
    def save_mapped_qc(self, filename: str) -> None: ...
    def save_mapped_qc_aod(self, filename: str) -> None: ...
    def save_synthesized_qc(self, filename: str) -> None: ...
    def schedule(self, verbose: bool = ..., create_animation_csv: bool = ..., shuttling_speed_factor: float = ...) -> dict[str, float]: ...
    def set_parameters(self, params: HybridMapperParameters) -> None: ...
