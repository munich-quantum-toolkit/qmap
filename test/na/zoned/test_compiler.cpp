...
constexpr std::string_view routingAwareNativeGateConfiguration = R"({
  "logLevel" : 1,
  "codeGeneratorConfig" : {
    "warnUnsupportedGates" : false
  },
  "decomposerConfig" : {
    "thetaOptSchedule" : true,
...
COMPILER_TEST(FastRelaxedRoutingAwareNativeGateCompiler,
              ...
              fastRelaxedRoutingAwareConfiguration);
COMPILER_TEST(RoutingAwareNativeGateCompiler, RoutingAwareNativeGateCompiler,
              routingAwareNativeGateConfiguration);
