...
_SCENARIOS = [
    ...
    pytest.param(_Scenario(16, 4, 0.015, None, 0.85, 0.050, 0.75, 0.050), id="chip16-t1.0-pe0.015"),
    ...
    pytest.param(_Scenario(16, 4, 0.015, 0.9, 0.65, 0.050, 0.55, 0.050), id="chip16-t0.9-pe0.015"),
    ...
    pytest.param(_Scenario(16, 4, 0.015, 0.8, 0.35, 0.050, 0.25, 0.050), id="chip16-t0.8-pe0.015"),
    ...
    pytest.param(_Scenario(16, 4, 0.015, 0.7, 0.25, 0.050, 0.15, 0.050), id="chip16-t0.7-pe0.015"),
